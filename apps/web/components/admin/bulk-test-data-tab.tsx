...
import { Loader2, Trash2, Eye, AlertTriangle, CheckCircle2 } from 'lucide-react'
...
export function BulkTestDataTab() {
      ...
      {preview && (
        <div>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold">Test Data Preview</h3>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="flex items-center gap-2">
              ...
              Confirm Bulk Test Data Deletion
            </AlertDialogTitle>
