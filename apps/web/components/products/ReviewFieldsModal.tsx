...
export function ReviewFieldsModal({
  ...
  const normalizeDocumentType = (type?: string): string => {
    ...
    const variations: Record<string, string> = {
      ...
      'non_gmo_statement': 'non_gmo_statement',
      'nongmo_statement': 'non_gmo_statement',
      'irradiation_statement': 'irradiation_statement',
      'irradiation_free_statement': 'irradiation_statement',
      'not_irradiated_statement': 'irradiation_statement',
      'bse_statement': 'bse_statement',
      'bse_free_statement': 'bse_statement',
      'tse_statement': 'bse_statement',
      'tse_free_statement': 'bse_statement',
      'prop_65_statement': 'prop65_statement',
      'prop65_statement': 'prop65_statement',
      'california_prop_65_statement': 'prop65_statement',
      'california_prop65_statement': 'prop65_statement',
