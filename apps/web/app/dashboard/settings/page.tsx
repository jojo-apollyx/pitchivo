    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-primary-light/20 via-background to-primary-light/10 relative overflow-hidden">
        ...
        <div className="relative">
          <section id="settings-header-section" className="sticky top-0 bg-background/95 backdrop-blur-sm z-10 border-b border-border/50">
            <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-display font-semibold tracking-tight text-foreground">Settings</h1>
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-primary-light/20 via-background to-primary-light/10 relative overflow-hidden">
      ...
      <div className="relative">
        ...
        {/* Tabs Content */}
        <section id="settings-tabs-section" className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <SettingsTabs
