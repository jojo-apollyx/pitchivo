  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-primary-light/20 via-background to-primary-light/10 relative overflow-hidden">
      ...
      <div className="relative">
        {/* Header */}
        <nav id="privacy-navigation" className="sticky top-0 z-50 border-b border-border/50 bg-background/95 backdrop-blur-sm">
        ...
        {/* Hero Section */}
        <section id="privacy-hero-section" className="py-12 sm:py-16 lg:py-20">
        ...
        <section className="py-12 sm:py-16 lg:py-20 border-b border-border/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 sm:p-8 transition-all duration-300 hover:shadow-lg hover:shadow-primary-light/20">
              <h2 className="text-2xl font-display font-bold mb-4">Our Commitment to Privacy</h2>
            ...
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-6 sm:p-8 transition-all duration-300 hover:shadow-lg hover:shadow-primary-light/20">
              <h2 className="text-2xl font-display font-bold mb-4">Third-Party Services</h2>
              <p className="text-base text-muted-foreground leading-relaxed mb-4">
