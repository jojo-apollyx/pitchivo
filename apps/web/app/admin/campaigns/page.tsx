      ...
      <div className="relative">
        ...
        <section className="sticky top-0 bg-background/95 backdrop-blur-sm z-10 border-b border-border/50">
          <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold">Campaigns Overview</h1>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-card/50 backdrop-blur-sm rounded-xl p-8 sm:p-12 transition-all duration-300 hover:shadow-lg hover:shadow-primary-light/20">
              <div className="text-center">
                ...
                <h2 className="text-xl sm:text-2xl font-semibold mb-2">Campaigns Overview</h2>
                <p className="text-base text-muted-foreground mb-2">Campaigns overview functionality coming soon</p>
                <p className="text-sm text-muted-foreground">This page will display all campaigns, analytics, and management tools</p>
              </div>
            </div>
          </div>
        </section>
